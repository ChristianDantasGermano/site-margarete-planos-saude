            ...
            <div className="grid grid-cols-3 gap-6 mt-5 mx-16 ">
              <div className="flex flex-col gap-6">
                <div>
                  ...
                  <p className="text-base-base">e cotação 100% online de acordo com seu perfil</p>
                </div>
                <div>
                  <h6 className="text-base-base font-semibold">Melhores preços</h6>
                  <p className="text-base-base">Cotação Online</p>
                </div>
              </div>
              <div className="flex flex-col gap-6">
                <div>
                  <h6 className="text-base-base font-semibold">Relacionamento</h6>
                ...
                <div>
                  <h6 className="text-base-base font-semibold">Soluções de acordo</h6>
                  <p className="text-base-base">
              ...
              <div className="flex flex-col gap-6">
                <div>
                  <h6 className="text-base-base font-semibold">Mais de 15 anos</h6>
                  <p className="text-base-base">no Mercado de Seguro e Planos de Saúde</p>
                </div>
                <div>
                  <h6 className="text-base-base font-semibold">Atendimento pessoal</h6>
                  <p className="text-base-base">
