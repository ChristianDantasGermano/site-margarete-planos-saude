  ...
  return (
    <div className="flex flex-col md:flex-row w-full">
      <div className="flex grow-0 flex-col md:max-w-xl 2xl:max-w-xl">
        ...
        <h4 className="font-sans text-sm md:text-base text-gray-700 mt-2 text-justify">
        ...
        <h4 className="font-sans text-sm md:text-base text-gray-700 text-justify">
      ...
      <div className="overflow-auto w-full h-full mt-4 md:m-4 flex grow justify-center items-center">
        <AsyncImage
