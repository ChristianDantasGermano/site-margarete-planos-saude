...
export default function Introducao() {
  return (
    <div className="flex flex-col md:flex-row pt-2 w-full">
      <div className="flex grow-0 flex-col md:max-w-md 2xl:max-w-xl">
        ...
        <h4 className="font-sans text-base md:text-lg text-gray-700 mt-2 text-justify">
        ...
        <h4 className="font-sans text-base md:text-lg text-gray-700 text-justify">
