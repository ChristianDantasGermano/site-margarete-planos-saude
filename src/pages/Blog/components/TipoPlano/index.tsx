            ...
            <div className="flex gap-4 md:m-6 overflow-hidden" key={index}>
              {index % 2 === 0 && (
                <div className="hidden md:flex h-full w-full max-h-[320px] max-w-[220px] ">
                  <AsyncImage
                    className="object-cover h-screen w-full max-h-[320px] max-w-[220px]  drop-shadow-lg border-collapse border-2 border-white"
                    src={beneficio.image}
              ...
              <div className="flex flex-col grow p-4 ">
                <div className="md:hidden flex h-full w-full justify-center items-center ">
                  <AsyncImage
                    className="object-contain h-screen w-full max-h-[320px] max-w-[220px]  drop-shadow-md border-collapse border-2 border-white"
                    src={beneficio.image}
                    Transition={(props) => <Blur radius={10} {...props} />}
                    loader={<div className="bg-base-tertiary" />}
                  />
